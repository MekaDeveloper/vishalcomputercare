...
class SliderComponent extends HTMLElement {
  ...
  initPages() {
    ...
    this.sliderItemOffset = this.sliderItemsToShow[2].offsetLeft - this.sliderItemsToShow[1].offsetLeft;
    this.slidesPerPage = Math.floor((this.slider.clientWidth - this.sliderItemsToShow[1].offsetLeft) / this.sliderItemOffset);
